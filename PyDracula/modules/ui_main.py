...
"")
        ...
        self.btn_map = QPushButton(self.topMenu)
        ...
        self.btn_map.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_map.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.btn_map.setAutoFillBackground(False)
        self.btn_map.setStyleSheet(u"background-image: url(:/icons/images/icons/cil-map.png);")

        self.verticalLayout_8.addWidget(self.btn_map)
        ...
        self.DamagelistWidget = QListWidget(self.extraContent)
        self.DamagelistWidget.setObjectName(u"DamagelistWidget")
        self.DamagelistWidget.setStyleSheet(u"background-color: transparent;")

        self.verticalLayout_12.addWidget(self.DamagelistWidget)
...
"background-repeat: no-repeat;")
        ...
        self.map_page.setObjectName(u"map_page")
        self.verticalLayout_20 = QVBoxLayout(self.map_page)
        self.verticalLayout_20.setObjectName(u"verticalLayout_20")
        self.webEngineView = QWebEngineView(self.map_page)
        self.webEngineView.setObjectName(u"webEngineView")
        self.webEngineView.setUrl(QUrl(u"about:blank"))

        self.verticalLayout_20.addWidget(self.webEngineView)

        self.frame = QFrame(self.map_page)
        ...
        self.InitializeButton = QPushButton(self.frame)
        self.InitializeButton.setObjectName(u"InitializeButton")
        self.InitializeButton.setMinimumSize(QSize(200, 30))
        self.InitializeButton.setMaximumSize(QSize(200, 30))
        self.InitializeButton.setStyleSheet(u".QPushButton { background-color: rgb(52, 59, 72); border: none;  border-radius: 5px; }\n"
...
"")
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/icons/cil-location-pin.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.InitializeButton.setIcon(icon4)

        self.horizontalLayout_7.addWidget(self.InitializeButton)
        ...
        self.label_2 = QLabel(self.topMenus)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toggleLeftBox.setText(QCoreApplication.translate("MainWindow", u"Damage List", None))
        self.extraLabel.setText(QCoreApplication.translate("MainWindow", u"Damage List", None))
        ...
        self.InitializeButton.setText(QCoreApplication.translate("MainWindow", u"Initialize Location", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Extra Tools", None))
